...
impl ShadowExperimentCounters {
    ...
    pub const fn new(
        ...
        shadow_drops: u64,
        shadow_jobs_admitted: u64,
        shadow_jobs_processed: u64,
        shadow_job_drops: u64,
        candidate_evaluations_attempted: u64,
        candidate_evaluations_completed: u64,
        candidate_evaluation_drops: u64,
    ...
    pub async fn record_shadow_counters(
        ...
        let _receipt = self
            ...
            .submit(WriteCommand::ShadowCompressionExperimentCounters {
                ...
                shadow_jobs_admitted: counters.shadow_jobs_admitted,
                shadow_jobs_processed: counters.shadow_jobs_processed,
                shadow_job_drops: counters.shadow_job_drops,
                candidate_evaluations_attempted: counters.candidate_evaluations_attempted,
                candidate_evaluations_completed: counters.candidate_evaluations_completed,
                candidate_evaluation_drops: counters.candidate_evaluation_drops,
